...
public enum ErrorCode {
    ...
    GOOGLE_4XX(HttpStatus.UNAUTHORIZED,"AUTH-004","해당 서비스가 google과 연결중에 문제가 발생했습니다."),
    GOOGLE_5XX(HttpStatus.INTERNAL_SERVER_ERROR,"AUTH-005","해당 서비스가 google과 연결중에 문제가 발생했습니다."),
    INVALID_ID_TOKEN(HttpStatus.INTERNAL_SERVER_ERROR,"AUTH-006","유효하지않은 ID TOKEN입니다.");
